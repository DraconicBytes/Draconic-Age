...
public class MobBSP extends EntityMob{

	//------------------------------------------------------------
	public MobBSP(World w) {
		super(w);
    ...
    public void dropFewItems(boolean par1, int par2){
    	if (this.rand.nextInt(10) == 0) this.dropItem(DAItems.scaleChest, 1);
        this.dropItem(DAItems.ironScale, 1);
        if(this.rand.nextInt(15) == 0) this.dropItem(DAItems.dragonScale, this.rand.nextInt(3)+1);
    }
